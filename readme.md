...
| Ping 테스트        | :heavy_check_mark: | :heavy_check_mark: |  [:heavy_check_mark:](https://github.com/Wiznet/wiznet-iot-shield-arduino-kr/blob/master/docs/Arduino_guide_wm-n400mse_ping.md)    | :heavy_check_mark:    | 네트워크 상의 지정된 목적지와 Ping 테스트 예제                   |
| TCP/IP 구현하기 | :heavy_check_mark: | :heavy_check_mark: |  [:heavy_check_mark:](https://github.com/Wiznet/wiznet-iot-shield-arduino-kr/blob/master/docs/Arduino_guide_wm-n400mse_tcp.md) | :heavy_check_mark: | TCP client로 동작하여 데이터 송신 및 수신하는 예제               |
