...
| Ping 테스트        | :heavy_check_mark: | :heavy_check_mark: |  [:heavy_check_mark:](https://github.com/Wiznet/wiznet-iot-shield-arduino-kr/blob/master/docs/Arduino_guide_wm-n400mse_ping.md)    | :heavy_multiplication_x:    | 네트워크 상의 지정된 목적지와 Ping 테스트 예제                   |
