...
### /samples/catm1
Arduino IDE에서 컴파일 및 업로드 하여 보드에서 직접 확인 할 수 있는 예제 코드가 위치합니다. 각 Cat.M1 모듈 벤더 별로 나뉘어 있으며, AT command 기반으로 구현되어 있습니다.
...
| ThingPlug 연동하기 | :heavy_check_mark: | :heavy_multiplication_x: | :heavy_multiplication_x: | :heavy_multiplication_x: | SKT의 클라우드 서비스인 ThingPlug 연동 예제와 Widget 활용 가이드 |
